<footer>
        ...
        <div class="text-center font-14 pt-5">Copyright © <?= date('Y'); ?> <b class="core-color">Hive</b> Framework - <a href="<?= Utils::getRoute('privacy-policy'); ?>">Privacy policy</a> - <a href="<?= Utils::getRoute('cookie-policy'); ?>">Cookie policy</a></div>
    </footer>