<?php
    ...
    // I automatically include each controller from the controllers folder recursively.
    $files = Utils::getPhpFiles($controllersPath);
    $files = array_diff($files, $ignoreControllers, $priorityControllers);
